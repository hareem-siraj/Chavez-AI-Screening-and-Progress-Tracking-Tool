...
interface SessionInfo {
  ...
  const ProgressOverviewUrdu: React.FC = () => {
    ...
    const explainGraph = async (graphKey: string, data: GraphInput) => {
      ...
      Please write a clear and caring explanation in easy to understand urdu for parents in 2 short paragraphs:
...
const fetchAllData = async (ids: string[]) => {
  ...
  const handleProfileSelection = () => {
    localStorage.clear();
    sessionStorage.clear();
    window.location.href = "/profile-selection-urdu";
  };
...
export default ProgressOverviewUrdu;
