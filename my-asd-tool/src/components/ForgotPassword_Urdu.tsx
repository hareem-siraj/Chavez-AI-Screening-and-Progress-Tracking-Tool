...
// const ForgotPasswordUrdu: React.FC = () => {
...
//         نیا پاس ورڈ بنانے کے لیے لنک حاصل کرنے کے لیے اپنا ای میل ایڈریس درج کریں۔
//         </Typography>
...
// export default ForgotPasswordUrdu;
...
const ForgotPasswordUrdu: React.FC = () => {
  ...
  const handleSubmit = async (event: React.FormEvent) => {
    ...
    try {
      ...
      setMessage("پاس ورڈ ریسٹ لنک آپ کے ای میل پر بھیج دیا گیا ہے!");
    } catch (error) {
      console.error("Error sending reset link:", error); // Log the error for debugging
      setError("Failed to send reset link. Please try again.");
    }
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Typography component="p" variant="body1" sx={{ mt: 1, mb: 3 }}>
        پاس ورڈ ریسٹ لنک حاصل کرنے کے لیے اپنا ای میل پتہ درج کریں
        </Typography>
