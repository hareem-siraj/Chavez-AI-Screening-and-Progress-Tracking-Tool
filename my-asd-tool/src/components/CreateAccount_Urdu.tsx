...
const CreateAccountUr: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      >
        ...
        شاویز کو استعمال کرنے کے لیے ایک اکاؤنٹ بنائیں
        </Typography>
        ...
        >
          <TextField
            ...
            fullWidth
            id="userId"
            label="اپنا یوزر آئی ڈی درج کریں۔"
            name="userId"
            value={userId}
          ...
          <TextField
            ...
            label="اپنا پاس ورڈ دوبارہ درج کریں۔"
            type="password"
            id="confirm-password"
...
export default CreateAccountUr;
